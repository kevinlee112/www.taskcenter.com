...
if (!isset($_SERVER['SERVER_ROLE']))
{
    ...
    strpos($_SERVER['HTTP_HOST'], 'bch') !== false && define('APP_ENVRION', 'beta');
    strpos($_SERVER['HTTP_HOST'], 'dev') === false && strpos($_SERVER['HTTP_HOST'], 'beta') === false && strpos($_SERVER['HTTP_HOST'], 'bch') === false && define('APP_ENVRION', 'product');
...
('product' !== APP_ENVRION) && error_reporting(E_ALL);
// 目录分隔符别名
...
//图库上传key
defined('PHOTO_PKEY') or define('PHOTO_PKEY','1ae425a5dd9f0a4fe51fde9c9ecd702d');
defined('PHOTO_MKEY') or define('PHOTO_MKEY','93eb83f5b4311bdce53d19a2464a897b');