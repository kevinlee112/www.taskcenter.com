    ...
    private function save($file) {
        ...
        if($this->thumb && in_array(strtolower($file['extension']),array('gif','jpg','jpeg','bmp','png'))) {
            ...
            if(false !== $image) {
                ...
                // 生成图像缩略图
                Yaf_Loader::import(PATH_FW_TOOLS . 'Image.php');
                for($i=0,$len=count($thumbWidth); $i<$len; $i++) {
                    ...
                    Tools_image::thumb($filename,$thumbPath.$thumbname.'.'.$file['extension'],'',$thumbWidth[$i],$thumbHeight[$i],true);
                }
